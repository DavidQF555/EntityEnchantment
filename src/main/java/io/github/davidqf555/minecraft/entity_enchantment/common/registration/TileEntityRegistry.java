...
public final class TileEntityRegistry {
    ...
    public static final RegistryObject<TileEntityType<ScrollTileEntity>> SCROLL = register("scroll", () -> TileEntityType.Builder.of(ScrollTileEntity::new, BlockRegistry.ENCHANTMENT_SHIFTER.get()).build(null));
